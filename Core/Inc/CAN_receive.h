     ...
     typedef enum
     {
         ...
         CAN_M4_2006_ID = 0x201,
         CAN_M5_2006_ID = 0x202,
         CAN_M6_2006_ID = 0x203,
         CAN_M1_6020_ID = 0x204,

         CAN_M2_6020_ID = 0x205,
         CAN_M3_6020_ID = 0x206,
		 CAN_temp_6020_ID = 0x204,
         CAN_GIMBAL_ALL_ID = 0x1FF, // Used by CAN_cmd_gimbal
